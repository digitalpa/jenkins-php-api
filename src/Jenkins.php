...
class Jenkins
{
    ...
    public function getViewConfig($viewPath, $api = false)
    {
        try {

            $url = UrlsFactory::getViewConfig($viewPath);
            if (!$api) {
                $url .= '/config.xml?unique=' . rand();
            } else {
                $url .= '/api/xml';
            }
    ...
    public function setViewConfig($viewPath, $configxml)
    {
        $url = UrlsFactory::getViewConfig($viewPath);
        $url .= '/config.xml';

        //   echo "view del setconfig:".$url;
